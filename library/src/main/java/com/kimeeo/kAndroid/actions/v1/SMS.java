...
public class SMS extends BaseAction {
            ...
            try {
                ...
                if (confirm && doNotAskAgain==false)
                {
                    ...
                    new AlertDialog.Builder(activity)
                            ...
                            .setTitle(R.string._mayCostSMSChargeTitle)
                            .setMessage(R.string._mayCostSMSCharge)
    ...
    @Override
    public String[] getFriendlyPermissionsMeaning() {return new String[]{"SMSComposer"};}
